...
{\bf These vertical velocities are associated with viscous
  GI, and should not be compared with those associated with the
  underlying gravito-turbulence \citep[e.g.][]{shi14}. Vertical
  velocities are formally neglected in our framework when defining the basic
  state (\S\ref{steady_state}).
}
