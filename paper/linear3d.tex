%On the other hand, if a time-independent heat source is invoked, then
%we may choose $\alpha, \beta$ and $\theta$ separately.  
...
growth rate. 
%The gravitational potential perturbation $\delta \Phi$ depends on $z$
%but only its midplane value $\delta \Phi(z=0)$ is
%used in the dynamical equations, which has the same form as above. 
For clarity, hereafter we drop the tilde.  
%and note that equilibrium
%quantities without the $\delta$ prefix. 
