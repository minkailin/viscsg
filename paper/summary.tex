...
%\citep{rafikov15}. 
%We show that, for linear dynamics, realistic 
...
%destabilize the disk at large radii. 
...
%This, in fact, has been suggested for 
...
%Whether these high
%density perturbations actually lead to a clump formation, 
...
Coriolis forces. %we have a physical way of lowering pressure/rotation
