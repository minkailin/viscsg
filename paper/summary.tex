...
{\bf However,} \cite{paardekooper12} also found {\bf in local grid-based simulations} that fragmentation can occur 
...
{\bf
  On the other hand, small-scale modes are more stable in 3D than in
  2D (Appendix \ref{3dcorr}), and thus the convergence issue may be
  less serious in 3D.  
}
