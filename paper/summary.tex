...
cooling on the equilibrium temperature of the disk, but merely used this 
to measure the classic Toomre Q and thereby assess stability. We demonstrate
through a more rigorous inclusion of these effects into the dispersion relation that
they can drive secondary instabilities.
...
cooling alone does not lead to gravitational instabilities. This is due
to stabilization by an effective `irradiation' associated with the PPD
cooling function, which is present even if 
there is no physical irradiation. Physically, this  term
...
height.
%%KMK
%Note that unlike our physical cooling function (Eq. \ref{real_cool}), the standard beta function in these
%numerical simulations cools towards zero temperature, rather than a temperature floor or irradiation temperature 
...
clumps reaching densities that are orders of magnitude above the ambient value. They must also survive
...
gravito-turbulent flucuations simply by chance. %KMK
