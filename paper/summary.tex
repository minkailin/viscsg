...
Our characteristic cooling time, given by 
Eq. \ref{betastar}, corresponds to a dimensionless viscosity 
as defined in the above studies\footnote{This differs from our
  definition of $\alpha$ by a factor of $\gamma^{-1}$.}  
\begin{align}
  \alpha =
  \frac{4}{9}\frac{1}{\gamma}\frac{\left(\sqrt{\gamma}-1\right)^{1/2}}{\left(\sqrt{\gamma}+1\right)}
  \simeq \begin{cases}
    0.062 & \gamma = 7/5, \\
    0.063 & \gamma = 5/3,\\
    0.059 & \gamma = 2.
