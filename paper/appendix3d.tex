...
cooling on the perturbations. Then the condition $AD = BC$ implies 
\begin{align}
...
\end{align}
which agrees with the above studies in the isothermal
limit \citep[$\gamma=1$; see also][their Eq. 28]{schmit95}.  
The non-isothermal term $\propto (\gamma-1)$
...
the domain $ z\in[0,\zmax]$ with a parity condition at the mid-plane.
...
condition at the mid-plane, %GI has even symmetry across midplane 
\begin{align}
