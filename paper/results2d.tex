...
Fig. \ref{invisc_theta} show growth rates in a $Q=1.7$ disk  
as a function of the cooling time $\beta$ for two irradiation levels
$\theta=0.1,\,0.33$. The vertical lines mark characterisic cooling
times beyond which the growth timescale is long compared to the
dynamical time. Increasing irradiation stablizes the
