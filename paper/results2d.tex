...
implications for numerical simulations probing large wavenumbers and small scales
...
the disk becomes more unstable at shorter wavelengths.  {\bf KMK -- I don't follow}
%show dK*/dbeta < 0 
...
%wavenumber $k$ obtained from the dispersion relation
%Eq. \ref{thindisk}. 
The limiting behavior for small/large $K$ are
