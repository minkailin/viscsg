...
%As perturbations are cooled to lower temperatures
%(decreasing $\theta$), the minimum $Q$ required for stability
%increases. 
...
If $|S_*|\ll1$, Eq. \ref{inviscid_max} gives the simple solution 
\begin{align}
