...
simulations. 
%This is understood within our framework as the disk's
%inability to sustain too large of a stress as it undermines
%rotational support against self-gravity. 
%This motivates an interpretation of disk 
%fragmentation as a secondary gravitational instability enabled by 
%the underlying gravito-turbulent viscosity when it exceeds a critical value.         
\end{abstract}
%opacity 
