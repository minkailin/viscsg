...
\begin{abstract}
  ...
  or when the corresponding turbulent viscosity is too large. The result is is disk fragmentation.         
...
for unstable modes with lengthscales on the order of the disk scale height.   
...
adiabatic (including isothermal) disk. 
