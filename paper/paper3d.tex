...
We derive a versatile dispersion relation for linear waves in a 
...
with the numerically-established empirical condition for disk fragmentation based on a
...
\S\ref{result_2d} and \S\ref{3ddisk} for 2D and 3D disks, respectively. In
