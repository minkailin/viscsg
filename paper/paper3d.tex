...
secondary instabilities driven by:  
\begin{inparaenum}[1)] 
\item 
...
radii \citep{helled14}. Studying these non-linear phenomena require
...
However, as we emphasize in this work, including non-ideal
...
We will quantify how cooling enables GI
...
demonstrated below, viscosity eliminates rotational support against  
...
physical effect due to turbulence, but we emphasize that viscous 
GI does not assume a particular origin for the viscosity. We will
...
three-dimensionality (3D). This allows us to consider viscous GI in
...
of spiral shocks. %new rafikov 16 
...
Represent the dynamic and thermodynamic effect of this turbulence by a
...
gravitational stability. This motivates a physical    
