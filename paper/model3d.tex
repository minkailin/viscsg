...
$\theta$ as the `irradiation level'. {\bf ASK} As we discuss in
\S\ref{2d_inviscid}, the limits $\theta \rightarrow 0, \theta
\rightarrow 1$ do not exactly correspond to the limits of
non-irradiated or irradiation-dominated disks as discussed in the
literature \citep{kratter11,rice11}. 
%stellar illum or envelope rad      
