...
that $\rho\nu$ is time-indpendent, following previous 
...
problem, $\nu\neq0$, we may set $\mathcal{H}_\mathrm{ext}=0$ to 
...
By beta cooling we mean the energy loss per unit volume is specified  
...
$\theta$ as the `irradiation level'. %stellar illum or envelope rad      
