...
{\bf For simplicity we refer to the adiabatic index $\gamma$ as that
  in Eq. \ref{ideal_eos} for both 2D and 3D disk models 
...
\subsection{Steady states and cooling models}\label{steady_state}
...
Physically, $\tirr$ {\bf may be} the floor temperature set by, 
