...
\author{Min-Kai Lin and Kaitlin M. Kratter}%, {\large \textcolor{blue}{\bf {\it 2016, ApJ, 824, 94}}}}
              ...
              \vspace{-.7cm}
               \begin{figure}
                 \includegraphics[width=\linewidth,clip=true,trim=0cm
                   0cm 0cm 0cm]{figures/compare_result_growth} 
              \end{figure}
               \vspace{-1cm}
                \begin{itemize}
                \item High $\dot{M}$ disk fragments $\gtrsim 100$AU
                \end{itemize}
            \end{block}
